...
const resources = {
  en: {
    translation: {
      ...
      vault_hero_title: 'A safe inside your wallet',
      vault_hero_body: 'Move funds into a vault that can only be opened with your YubiKey. Both deposits and withdrawals need the key, your PIN, and a touch.',
      vault_unsupported_title: 'Needs a YubiKey',
      vault_unsupported_body: 'The vault requires a YubiKey 5C and a device that can read it over USB-C or NFC.',
      ...
      vault_deposit_sub: 'Move funds from your everyday balance into the vault. Requires your YubiKey.',
      vault_withdraw_sub: 'Move funds back to your everyday balance. Requires your YubiKey.',
      ...
      // enrollment
      vault_enroll_title: 'Set up your vault',
      vault_enroll_intro: 'Your YubiKey will generate a private key that never leaves the card — it signs vault withdrawals directly. Have it ready to insert.',
      vault_back: 'Back',
      ...
      vault_passphrase_intro:
        'This passphrase combines with the wallet recovery phrase you already have. There is no second phrase to write down — but this passphrase becomes just as important as the first.',
      vault_passphrase_no_reset:
        'Store this passphrase with your recovery phrase. It cannot be reset or recovered, and changing it later means moving every coin into a new vault.',
  ...
  zh: {
    translation: {
      ...
      vault_title: '保险库',
      vault_row_title: '保险库',
      vault_hero_title: '钱包中的保险箱',
      vault_hero_body: '将资金转入只能用 YubiKey 打开的保险库。存入和提取均需要密钥、PIN 码并轻触密钥。',
      vault_unsupported_title: '需要 YubiKey',
      vault_unsupported_body: '保险库需要 YubiKey 5C，以及可通过 USB-C 或 NFC 读取它的设备。',
      ...
      vault_deposit_sub: '将资金从日常余额转入保险库。需要您的 YubiKey。',
      vault_withdraw_sub: '将资金转回日常余额。需要您的 YubiKey。',
      ...
      vault_enroll_title: '设置您的保险库',
      vault_enroll_intro: '您的 YubiKey 将保管锁定保险库的私钥。请准备好插入。',
  ...
  hi: {
    translation: {
      ...
      vault_hero_title: 'आपके वॉलेट के अंदर एक तिजोरी',
      vault_hero_body: 'धन को एक ऐसे वॉल्ट में ले जाएँ जिसे केवल आपकी YubiKey से ही खोला जा सकता है। जमा और निकासी, दोनों के लिए कुंजी, आपका PIN और एक स्पर्श चाहिए।',
      vault_unsupported_title: 'YubiKey चाहिए',
      vault_unsupported_body: 'वॉल्ट के लिए एक YubiKey 5C और ऐसा उपकरण चाहिए जो इसे USB-C या NFC से पढ़ सके।',
      ...
      vault_deposit_sub: 'अपने रोज़मर्रा के बैलेंस से धन वॉल्ट में ले जाएँ। आपकी YubiKey आवश्यक है।',
      vault_withdraw_sub: 'धन वापस अपने रोज़मर्रा के बैलेंस में ले जाएँ। आपकी YubiKey आवश्यक है।',
      ...
      vault_enroll_title: 'अपना वॉल्ट सेट करें',
      vault_enroll_intro: 'आपकी YubiKey एक निजी कुंजी की रक्षा करेगी जो वॉल्ट को लॉक करती है। इसे डालने के लिए तैयार रखें।',
      ...
      vault_enter_pin: 'अपना PIN दर्ज करें',
  ...
  es: {
    translation: {
      ...
      vault_hero_title: 'Una caja fuerte dentro de tu monedero',
      vault_hero_body: 'Mueve fondos a una caja fuerte que solo se puede abrir con tu YubiKey. Tanto los depósitos como las retiradas necesitan la llave, tu PIN y un toque.',
      vault_unsupported_title: 'Necesita una YubiKey',
      vault_unsupported_body: 'La caja fuerte requiere una YubiKey 5C y un dispositivo que pueda leerla por USB-C o NFC.',
      ...
      vault_deposit_sub: 'Mueve fondos de tu saldo diario a la caja fuerte. Requiere tu YubiKey.',
      vault_withdraw_sub: 'Devuelve fondos a tu saldo diario. Requiere tu YubiKey.',
      ...
      vault_enroll_title: 'Configura tu caja fuerte',
      vault_enroll_intro: 'Tu YubiKey protegerá una clave privada que bloquea la caja fuerte. Tenla lista para insertarla.',
      ...
      vault_enter_pin: 'Introduce tu PIN',
  ...
  fr: {
    translation: {
      ...
      vault_hero_title: 'Un coffre-fort dans votre portefeuille',
      vault_hero_body: 'Placez des fonds dans un coffre qui ne peut être ouvert qu\'avec votre YubiKey. Les dépôts comme les retraits nécessitent la clé, votre PIN et un contact.',
      vault_unsupported_title: 'Nécessite une YubiKey',
      vault_unsupported_body: 'Le coffre nécessite une YubiKey 5C et un appareil capable de la lire via USB-C ou NFC.',
      ...
      vault_deposit_sub: 'Transférez des fonds de votre solde courant vers le coffre. Nécessite votre YubiKey.',
      vault_withdraw_sub: 'Renvoyez des fonds vers votre solde courant. Nécessite votre YubiKey.',
      ...
      vault_enroll_title: 'Configurez votre coffre',
      vault_enroll_intro: 'Votre YubiKey protégera une clé privée qui verrouille le coffre. Ayez-la prête à insérer.',
      ...
      vault_enter_pin: 'Saisissez votre PIN',
  ...
  ar: {
    translation: {
      ...
      vault_hero_title: 'خزنة داخل محفظتك',
      vault_hero_body: 'انقل الأموال إلى خزنة لا يمكن فتحها إلا بمفتاح YubiKey الخاص بك. يتطلب كل من الإيداع والسحب المفتاح ورمز PIN ولمسة.',
      vault_unsupported_title: 'يتطلب YubiKey',
      vault_unsupported_body: 'تتطلب الخزنة مفتاح YubiKey 5C وجهازًا يمكنه قراءته عبر USB-C أو NFC.',
      ...
      vault_deposit_sub: 'انقل الأموال من رصيدك اليومي إلى الخزنة. يتطلب مفتاح YubiKey الخاص بك.',
      vault_withdraw_sub: 'أعد الأموال إلى رصيدك اليومي. يتطلب مفتاح YubiKey الخاص بك.',
      ...
      vault_enroll_title: 'إعداد خزنتك',
      vault_enroll_intro: 'سيحمي مفتاح YubiKey مفتاحًا خاصًا يقفل الخزنة. جهّزه للإدخال.',
  ...
  pt: {
    translation: {
      ...
      vault_hero_title: 'Um cofre dentro da sua carteira',
      vault_hero_body: 'Mova fundos para um cofre que só pode ser aberto com a sua YubiKey. Tanto os depósitos como as retiradas exigem a chave, o seu PIN e um toque.',
      vault_unsupported_title: 'Requer uma YubiKey',
      vault_unsupported_body: 'O cofre requer uma YubiKey 5C e um dispositivo capaz de lê-la por USB-C ou NFC.',
      ...
      vault_deposit_sub: 'Mova fundos do seu saldo do dia a dia para o cofre. Requer a sua YubiKey.',
      vault_withdraw_sub: 'Mova fundos de volta ao seu saldo do dia a dia. Requer a sua YubiKey.',
      ...
      vault_enroll_title: 'Configure o seu cofre',
      vault_enroll_intro: 'A sua YubiKey guardará uma chave privada que tranca o cofre. Tenha-a pronta para inserir.',
      ...
      vault_enter_pin: 'Digite o seu PIN',
  ...
  bn: {
    translation: {
      ...
      vault_hero_title: 'আপনার ওয়ালেটের ভেতরে একটি সিন্দুক',
      vault_hero_body: 'তহবিল এমন একটি ভল্টে সরান যা কেবল আপনার YubiKey দিয়ে খোলা যায়। জমা এবং উত্তোলন — উভয়ের জন্যই কী, আপনার PIN এবং একটি স্পর্শ প্রয়োজন।',
      vault_unsupported_title: 'YubiKey প্রয়োজন',
      vault_unsupported_body: 'ভল্টের জন্য একটি YubiKey 5C এবং এমন একটি ডিভাইস প্রয়োজন যা এটি USB-C বা NFC দিয়ে পড়তে পারে।',
      ...
      vault_deposit_sub: 'আপনার দৈনন্দিন ব্যালেন্স থেকে তহবিল ভল্টে সরান। আপনার YubiKey প্রয়োজন।',
      vault_withdraw_sub: 'তহবিল আবার আপনার দৈনন্দিন ব্যালেন্সে সরান। আপনার YubiKey প্রয়োজন।',
      ...
      vault_enroll_title: 'আপনার ভল্ট সেট আপ করুন',
      vault_enroll_intro: 'আপনার YubiKey একটি প্রাইভেট কী রক্ষা করবে যা ভল্ট লক করে। এটি ঢোকানোর জন্য প্রস্তুত রাখুন।',
      ...
      vault_enter_pin: 'আপনার PIN লিখুন',
  ...
  ru: {
    translation: {
      ...
      vault_hero_title: 'Сейф внутри вашего кошелька',
      vault_hero_body: 'Переместите средства в хранилище, которое можно открыть только с помощью YubiKey. Как для пополнения, так и для вывода нужны ключ, PIN-код и касание.',
      vault_unsupported_title: 'Требуется YubiKey',
      vault_unsupported_body: 'Для хранилища нужны YubiKey 5C и устройство, способное считать его через USB-C или NFC.',
      ...
      vault_deposit_sub: 'Переместите средства с повседневного баланса в хранилище. Требуется ваш YubiKey.',
      vault_withdraw_sub: 'Верните средства на повседневный баланс. Требуется ваш YubiKey.',
      ...
      vault_enroll_title: 'Настройте хранилище',
      vault_enroll_intro: 'Ваш YubiKey будет хранить закрытый ключ, запирающий хранилище. Приготовьте его для вставки.',
      ...
      vault_enter_pin: 'Введите PIN-код',
  ...
  id: {
    translation: {
      ...
      vault_hero_title: 'Brankas di dalam dompet Anda',
      vault_hero_body: 'Pindahkan dana ke brankas yang hanya bisa dibuka dengan YubiKey Anda. Setoran maupun penarikan sama-sama memerlukan kunci, PIN, dan sentuhan.',
      vault_unsupported_title: 'Memerlukan YubiKey',
      vault_unsupported_body: 'Brankas memerlukan YubiKey 5C dan perangkat yang dapat membacanya melalui USB-C atau NFC.',
      ...
      vault_deposit_sub: 'Pindahkan dana dari saldo harian Anda ke brankas. Memerlukan YubiKey Anda.',
      vault_withdraw_sub: 'Pindahkan dana kembali ke saldo harian Anda. Memerlukan YubiKey Anda.',
      ...
      vault_enroll_title: 'Siapkan brankas Anda',
      vault_enroll_intro: 'YubiKey Anda akan menjaga kunci privat yang mengunci brankas. Siapkan untuk dimasukkan.',
      ...
      vault_enter_pin: 'Masukkan PIN Anda',
  ...
  ja: {
    translation: {
      ...
      vault_title: '保管庫',
      vault_row_title: '保管庫',
      vault_hero_title: 'ウォレット内の金庫',
      vault_hero_body: 'YubiKey でのみ開ける保管庫に資金を移動します。入金・出金のどちらにも鍵、PIN、タッチが必要です。',
      vault_unsupported_title: 'YubiKey が必要です',
      vault_unsupported_body: '保管庫には YubiKey 5C と、USB-C または NFC で読み取れるデバイスが必要です。',
      ...
      vault_deposit_sub: '普段の残高から保管庫に資金を移動します。YubiKey が必要です。',
      vault_withdraw_sub: '普段の残高に資金を戻します。YubiKey が必要です。',
      ...
      vault_enroll_title: '保管庫を設定',
      vault_enroll_intro: 'YubiKey が保管庫をロックする秘密鍵を保護します。挿入できるよう準備してください。',
  ...
  pl: {
    translation: {
      ...
      vault_hero_title: 'Sejf w Twoim portfelu',
      vault_hero_body: 'Przenieś środki do sejfu, który można otworzyć tylko za pomocą YubiKey. Zarówno wpłaty, jak i wypłaty wymagają klucza, PIN-u i dotknięcia.',
      vault_unsupported_title: 'Wymaga YubiKey',
      vault_unsupported_body: 'Sejf wymaga YubiKey 5C oraz urządzenia, które może go odczytać przez USB-C lub NFC.',
      ...
      vault_deposit_sub: 'Przenieś środki z codziennego salda do sejfu. Wymaga YubiKey.',
      vault_withdraw_sub: 'Przenieś środki z powrotem na codzienne saldo. Wymaga YubiKey.',
      ...
      vault_enroll_title: 'Skonfiguruj sejf',
      vault_enroll_intro: 'Twój YubiKey będzie strzegł klucza prywatnego blokującego sejf. Przygotuj go do włożenia.',
