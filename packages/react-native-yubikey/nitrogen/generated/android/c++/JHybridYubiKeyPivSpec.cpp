...
namespace margelo::nitro::yubikeypiv {
  ...
  std::shared_ptr<Promise<std::string>> JHybridYubiKeyPivSpec::isVaultSlotOccupied(const std::string& expectedSerial) {
    static const auto method = _javaPart->javaClassStatic()->getMethod<jni::local_ref<JPromise::javaobject>(jni::alias_ref<jni::JString> /* expectedSerial */)>("isVaultSlotOccupied");
    auto __result = method(_javaPart, jni::make_jstring(expectedSerial));
    return [&]() {
      auto __promise = Promise<std::string>::create();
      __result->cthis()->addOnResolvedListener([=](const jni::alias_ref<jni::JObject>& __boxedResult) {
  ...
  std::shared_ptr<Promise<std::string>> JHybridYubiKeyPivSpec::resetPivApplication(const std::string& expectedSerial) {
    static const auto method = _javaPart->javaClassStatic()->getMethod<jni::local_ref<JPromise::javaobject>(jni::alias_ref<jni::JString> /* expectedSerial */)>("resetPivApplication");
    auto __result = method(_javaPart, jni::make_jstring(expectedSerial));
    return [&]() {
      auto __promise = Promise<std::string>::create();
      __result->cthis()->addOnResolvedListener([=](const jni::alias_ref<jni::JObject>& __boxedResult) {
