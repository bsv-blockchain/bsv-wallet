///
/// HybridYubiKeyPivSpec_cxx.swift
...
/**
 * A class implementation that bridges HybridYubiKeyPivSpec over to C++.
 ...
 */
open class HybridYubiKeyPivSpec_cxx {
  /**
   * The Swift <> C++ bridge's namespace (`margelo::nitro::yubikeypiv::bridge::swift`)
   * from `YubiKeyPiv-Swift-Cxx-Bridge.hpp`.
   * This contains specialized C++ templates, and C++ helper functions that can be accessed from Swift.
   */
  public typealias bridge = margelo.nitro.yubikeypiv.bridge.swift

  /**
   * Holds an instance of the `HybridYubiKeyPivSpec` Swift protocol.
   */
  private var __implementation: any HybridYubiKeyPivSpec

  /**
   * Holds a weak pointer to the C++ class that wraps the Swift class.
   */
  private var __cxxPart: bridge.std__weak_ptr_HybridYubiKeyPivSpec_

  /**
   * Create a new `HybridYubiKeyPivSpec_cxx` that wraps the given `HybridYubiKeyPivSpec`.
   * All properties and methods bridge to C++ types.
   */
  public init(_ implementation: any HybridYubiKeyPivSpec) {
  ...
  /**
   * Get the actual `HybridYubiKeyPivSpec` instance this class wraps.
   */
  @inline(__always)
  public func getHybridYubiKeyPivSpec() -> any HybridYubiKeyPivSpec {
  ...
  /**
   * Casts an unsafe pointer to a `HybridYubiKeyPivSpec_cxx`.
   * The pointer has to be a retained opaque `Unmanaged<HybridYubiKeyPivSpec_cxx>`.
   * This removes one strong reference from the object!
   */
  public class func fromUnsafe(_ pointer: UnsafeMutableRawPointer) -> HybridYubiKeyPivSpec_cxx {
    return Unmanaged<HybridYubiKeyPivSpec_cxx>.fromOpaque(pointer).takeRetainedValue()
  }

  /**
   * Gets (or creates) the C++ part of this Hybrid Object.
   * The C++ part is a `std::shared_ptr<HybridYubiKeyPivSpec>`.
   */
  public func getCxxPart() -> bridge.std__shared_ptr_HybridYubiKeyPivSpec_ {
    let cachedCxxPart = self.__cxxPart.lock()
    if Bool(fromCxx: cachedCxxPart) {
      return cachedCxxPart
    } else {
      let newCxxPart = bridge.create_std__shared_ptr_HybridYubiKeyPivSpec_(self.toUnsafe())
      __cxxPart = bridge.weakify_std__shared_ptr_HybridYubiKeyPivSpec_(newCxxPart)
      return newCxxPart
    }
  }
   ...
   */
  @inline(__always)
  public func equals(other: HybridYubiKeyPivSpec_cxx) -> Bool {
  ...
  public final func setKeyListener(listener: bridge.Func_void_std__string_std__string_std__string) -> bridge.Result_void_ {
    do {
      try self.__implementation.setKeyListener(listener: { () -> (String, String, String) -> Void in
        let __wrappedFunction = bridge.wrap_Func_void_std__string_std__string_std__string(listener)
        return { (__eventType: String, __serial: String, __transport: String) -> Void in
          __wrappedFunction.call(std.string(__eventType), std.string(__serial), std.string(__transport))
        }
      }())
      return bridge.create_Result_void_()
    } catch (let __error) {
  ...
  public final func clearKeyListener() -> bridge.Result_void_ {
    do {
      try self.__implementation.clearKeyListener()
      return bridge.create_Result_void_()
    } catch (let __error) {
      let __exceptionPtr = __error.toCpp()
      return bridge.create_Result_void_(__exceptionPtr)
  ...
  public final func getKeyInfo() -> bridge.Result_std__shared_ptr_Promise_std__string___ {
    do {
      let __result = try self.__implementation.getKeyInfo()
  ...
  @inline(__always)
  public final func isVaultSlotOccupied(expectedSerial: std.string) -> bridge.Result_std__shared_ptr_Promise_std__string___ {
    do {
      let __result = try self.__implementation.isVaultSlotOccupied(expectedSerial: String(expectedSerial))
      let __resultCpp = { () -> bridge.std__shared_ptr_Promise_std__string__ in
        let __promise = bridge.create_std__shared_ptr_Promise_std__string__()
        let __promiseHolder = bridge.wrap_std__shared_ptr_Promise_std__string__(__promise)
        __result
  ...
  @inline(__always)
  public final func resetPivApplication(expectedSerial: std.string) -> bridge.Result_std__shared_ptr_Promise_std__string___ {
    do {
      let __result = try self.__implementation.resetPivApplication(expectedSerial: String(expectedSerial))
      let __resultCpp = { () -> bridge.std__shared_ptr_Promise_std__string__ in
        let __promise = bridge.create_std__shared_ptr_Promise_std__string__()
        let __promiseHolder = bridge.wrap_std__shared_ptr_Promise_std__string__(__promise)
        __result
