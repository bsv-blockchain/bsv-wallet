...
const resources = {
  en: {
    translation: {
      ...
      backup_push_off_message: 'Your recovery phrase alone cannot rebuild this wallet. Information associated with securing your coins exists only in the database, so with backups off, a new device can restore your phrase but not your funds. Nothing already on the server is deleted.',
      ...
      vault_err_bad_derivation_index:
        'Wrong device used, please check the serial number matches.',
      ...
      restore_backup_failed_message: 'Your recovery phrase is fine, but the encrypted backup could not be replayed. Trying again is usually enough. Continuing without it gives you a working wallet with no past transactions, and some of your existing coins will not be spendable.',
      ...
      offline_stall_foreign_ancestor: 'A queued payment is waiting on a parent transaction another wallet never processed.',
  ...
  hi: {
    translation: {
      ...
      resend_failed_no_recipient: 'इस भुगतान में यह दर्ज नहीं है कि यह किसके लिए था, इसलिए इसे दोबारा नहीं भेजा जा सकता।',
  ...
  es: {
    translation: {
      ...
      resend_failed_no_record: 'No se encontraron los detalles de este pago en este dispositivo, así que no se puede reenviar.',
  ...
  fr: {
    translation: {
      ...
      resend_failed_no_record: 'Les détails de ce paiement sont introuvables sur cet appareil : impossible de le renvoyer.',
  ...
  pl: {
    translation: {
      ...
      resend_failed_no_transaction: 'Nie udało się pobrać danych tej płatności. Spróbuj ponownie po połączeniu z siecią.',
      resend_requested: 'They asked you to resend a payment',
      request_again: 'Request again',
      send_again: 'Send again',
      copy_details: 'Copy details',
