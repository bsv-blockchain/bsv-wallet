...
const resources = {
  ...
  zh: {
    translation: {
      ...
      profile_handle_invalid: '3-20 个小写字母、数字、_ 或 -',
  ...
  hi: {
    translation: {
      ...
      profile_handle_invalid: '3-20 लोअरकेस अक्षर, अंक, _ या -',
  ...
  bn: {
    translation: {
      ...
      profile_handle_invalid: '3-20 ছোট হাতের অক্ষর, সংখ্যা, _ অথবা -',
  ...
  ru: {
    translation: {
      ...
      profile_handle_invalid: '3-20 строчных букв, цифр, _ или -',
  ...
  id: {
    translation: {
      ...
      profile_handle_invalid: '3-20 huruf kecil, angka, _ atau -',
  ...
  ja: {
    translation: {
      ...
      profile_handle_invalid: '3〜20文字の小文字、数字、_ または -',
